...
async function main() {
  ...
  const admin = await prisma.user.upsert({
    where: { email: "admin@workforce.in" },
    update: {},
    create: {
      email: "admin@workforce.in",
      phone: "9999999999",
      name: "Admin",
      role: "ADMIN",
      city: "Hyderabad",
  ...
  const workers = [
    { email: "rajesh@example.com", phone: "9000000001", name: "Rajesh Kumar", trade: "Assembly Line Worker", experience: 3, salary: 12000, city: "Jeedimetla" },
    { email: "suresh@example.com", phone: "9000000002", name: "Suresh Reddy", trade: "Machine Operator", experience: 5, salary: 15000, city: "Patancheru" },
    { email: "amit@example.com", phone: "9000000003", name: "Amit Singh", trade: "Packaging Worker", experience: 2, salary: 10000, city: "Bolaram" },
    { email: "venkatesh@example.com", phone: "9000000004", name: "Venkatesh Rao", trade: "Warehouse Helper", experience: 4, salary: 11000, city: "Bahadurpally" },
    { email: "ravi@example.com", phone: "9000000005", name: "Ravi Teja", trade: "Quality Checker", experience: 6, salary: 18000, city: "Shamshabad" },
    { email: "mohan@example.com", phone: "9000000006", name: "Mohan Das", trade: "Fabrication Worker", experience: 8, salary: 20000, city: "Cherlapally" },
    { email: "kishore@example.com", phone: "9000000007", name: "Kishore Babu", trade: "CNC Operator", experience: 5, salary: 16000, city: "Nacharam" },
    { email: "prakash@example.com", phone: "9000000008", name: "Prakash Jha", trade: "Maintenance Worker", experience: 7, salary: 14000, city: "Sanathnagar" },
    { email: "dinesh@example.com", phone: "9000000009", name: "Dinesh Yadav", trade: "Assembly Line Worker", experience: 1, salary: 9000, city: "Kompally" },
    { email: "gopal@example.com", phone: "9000000010", name: "Gopal Reddy", trade: "Loading/Unloading Helper", experience: 3, salary: 10000, city: "Balanagar" },
  ];

  for (const w of workers) {
    const user = await prisma.user.upsert({
      where: { email: w.email },
      update: { name: w.name, city: w.city, phone: w.phone },
      create: {
        email: w.email,
        phone: w.phone,
        name: w.name,
  ...
  const employers = [
    { email: "anil@abcfans.com", phone: "9000000101", name: "Anil Kumar", company: "ABC Fans Pvt Ltd", industry: "Fan Manufacturing", address: "Jeedimetla Industrial Area" },
    { email: "vijay@precision.in", phone: "9000000102", name: "Vijay Reddy", company: "Precision Components", industry: "Automobile Parts", address: "Patancheru" },
    { email: "sunil@packwell.com", phone: "9000000103", name: "Sunil Gupta", company: "PackWell Industries", industry: "Packaging", address: "Bolaram" },
    { email: "ramesh@techassemble.com", phone: "9000000104", name: "Rameshwar Rao", company: "TechAssemble Ltd", industry: "Electronics Assembly", address: "Cherlapally" },
  ];
